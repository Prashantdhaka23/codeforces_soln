...
void dfs(int i ,vector<int> & vis ,vector<unordered_set<int>> & adj,vector<int> & v){
    vis[i]=1;
    v.push_back(i);
...
void dfs2(int i ,vector<int> & vis ,vector<unordered_set<int>> & adj,int & v){
    vis[i]=1;
    v++;
