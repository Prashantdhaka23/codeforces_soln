...
void dfs(int node ,int par,vector<vector<int>> & adj,vector<vector<int>> & dp,vector<int> & level,int l){
...
vector<vector<int>> dp(n+2,vector<int> (20,0));
vector<int> level(n+2,0);

dfs( 1 , 0,adj,dp,level,x);
