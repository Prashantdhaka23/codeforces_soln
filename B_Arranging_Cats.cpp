...
int min_operations(int n, string initial_state, string final_state) {
    int initial_cats = count(initial_state.begin(), initial_state.end(), '1');
    int final_cats = count(final_state.begin(), final_state.end(), '1');

    int add_operations = max(0, final_cats - initial_cats);
    int remove_operations = max(0, initial_cats - final_cats);
    ...
    int x=move_operations-(abs(final_cats - initial_cats));

    return add_operations + remove_operations + (x+1)/2;
}
...
int main() {
    ...
    while (t--) {
        ...
        int result = min_operations(n, initial_state, final_state);
        cout << result << endl;
    }
