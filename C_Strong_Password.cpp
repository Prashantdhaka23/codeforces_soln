...
int dfs( int ind,string & a,string & b ,int d){

if(ind==a.size()) return 1;
if(dp[ind][d+1]!=-1)return dp[ind][d+1];
...
auto  j=upper_bound(mp[i].begin(),mp[i].end(),d);
