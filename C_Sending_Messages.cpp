...
string canSendMessage(int n, int initial_charge, int consumption_per_time, int consumption_turn_off_on, vector<int>& moments) {
    int current_charge = initial_charge;

    for (int i = 0; i < n; ++i) {
        int time_diff = (i == 0) ? moments[i] : (moments[i] - moments[i - 1]);
        int required_charge = (time_diff )* consumption_per_time;
           required_charge = min(required_charge,  consumption_turn_off_on);
...
int32_t main() {
    ...
    while (t--) {
        int n, initial_charge, consumption_per_time, consumption_turn_off_on;
        cin >> n >> initial_charge >> consumption_per_time >> consumption_turn_off_on;
        ...
        string result = canSendMessage(n, initial_charge, consumption_per_time, consumption_turn_off_on, moments);
        cout << result << endl;
    }
