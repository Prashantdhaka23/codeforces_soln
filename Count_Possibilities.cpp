...
int m;
cin>>m;
vector<int> arrival(m,0);
vector<int> brustTime(m,0);
...
//     int m = arrival.size();
//     vector<int> available_servers(n);
//     vector<pair<int, int>> process;
//     vector<int> ans(m, 0);

//     for (int i = 0; i < n; i++) {
//         available_servers[i] = i + 1;
//     }

//     make_heap(available_servers.begin(), available_servers.end());

//     vector< pair<int, pair<int, int> > sorted_data;
//     for (int i = 0; i < m; i++) {
//         sorted_data.push_back(make_pair(arrival[i], make_pair(i, burstTime[i]));
//     }
//     sort(sorted_data.begin(), sorted_data.end());

//     for (int i = 0; i < m; i++) {
//         int a = sorted_data[i].first;
//         int index = sorted_data[i].second.first;
//         int b = sorted_data[i].second.second;

//         while (!process.empty() && process[0].first <= a) {
//             pop_heap(process.begin(), process.end());
//             available_servers.push_back(process.back().second);
//             process.pop_back();
//         }

//         if (!available_servers.empty()) {
//             int server = available_servers.front();
//             pop_heap(available_servers.begin(), available_servers.end());
//             available_servers.pop_back();
//             ans[index] = server;
//             process.push_back(make_pair(a + b, server));
//             push_heap(process.begin(), process.end());
//         } else {
//             ans[index] = -1;
//         }
//     }
...
//     vector<int> burstTime = {5, 2, 4, 2};

//     vector<int> result = getServerIndex(n, arrival, burstTime);

//     for (int i = 0; i < result.size(); i++) {
//         cout << "Task " << i << " assigned to Server " << result[i] << endl;
//     }
...
// 120
// LRU 
// Over all service publish an event 
// 40gbpd
// 2,4
