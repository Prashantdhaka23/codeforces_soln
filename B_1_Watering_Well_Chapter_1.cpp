...
vector<int> hash1(3100,0);
vector<int> hash2(3100,0);
vector<int> hash3(3100,0);
vector<int> hash4(3100,0);
...
hash3[x[i]]++;
 ...
 vector<int> mp(3100,0);
 for(int i=1;i<=3000;i++){
    for(int j=1;j<=3000;j++){
      mp[abs(i-j)]+=(hash1[i]*hash3[j]);
      mp[abs(i-j)]+=hash2[i]*hash4[j];
    }
 }
 for(int x1=0;x1<=3000;x1++){
    int y1=mp[x1];
    ans+=(((x1*x1)%mod)*y1%mod)%mod;
    ans=ans%mod;
